package com.fh.service.information.collection;
...
public class CollectionService {
	...
	*列表(全部)
	*/
	public List<PageData> listByMemid(PageData pd)throws Exception{
		return (List<PageData>)dao.findForList("CollectionMapper.listByMemid", pd);
	}
