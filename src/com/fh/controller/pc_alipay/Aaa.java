package com.fh.controller.pc_alipay;
...
import com.fh.controller.pc_alipay.config.AlipayConfig;

@Controller
@RequestMapping("/api/pc_alipay")
public class Aaa extends BaseController{
	@RequestMapping(value="/index")
	public ModelAndView index(){
		ModelAndView mv=new ModelAndView();
		mv.setViewName("pc_alipay/index");
		return mv;
	}
	...
	public ModelAndView pc_alipay(HttpServletRequest request) throws Exception{
		...
		mv.setViewName("alipay/alireturn");
		return mv;
	}
	/**
	 * 支付成功回调
