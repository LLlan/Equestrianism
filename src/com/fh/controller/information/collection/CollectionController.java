package com.fh.controller.information.collection;
...
public class CollectionController extends BaseController {
	...
	public ModelAndView list(Page page){
		...
		try{
			...
			mv.setViewName("information/collection/collection_list");
	...
	public ModelAndView goAdd(){
		logBefore(logger, "去新增Collection页面");
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		try {
			mv.setViewName("information/collection/collection_edit");
	...
	public ModelAndView goEdit(){
		logBefore(logger, "去修改Collection页面");
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		try {
	...
	public Object deleteAll() {
		logBefore(logger, "批量删除Collection");
		PageData pd = new PageData();		
	...
	public ModelAndView exportExcel(){
		logBefore(logger, "导出Collection到excel");
		...
		try{
			...
			for(int i=0;i<varOList.size();i++){
				...
				vpd.put("var2", varOList.get(i).getString("MEMID"));	//2
				vpd.put("var3", varOList.get(i).getString("ID"));	//3
