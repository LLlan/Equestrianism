...
<div id="main">
        <form name="alipayment" action="<%=basePath %>api/alipay/alipayapi1.do" method="post" target="_blank">
...
<script language="javascript">
	function GetDateNow() {
		...
		document.getElementById("WIDshow_url").value = "https://item.taobao.com/item.htm?spm=a217m.8316598.701916.4.DJlATQ&id=552203794511";
	}
	GetDateNow();
</script>
</html>