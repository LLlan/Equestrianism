...
<base href="<%=basePath%>">
    ...
    <link rel="stylesheet" href="static/css/xinmeiti/zhibo.css"/>
    ...
    <script src="static/js/xinmeiti/zhibo.js"></script>
    <title>网红视频直播</title>
</head>
<body>
<!--顶部-->
...
<div class="listFrm clearfix">
        ...
        <ul class="select">
            <li class="select-list">
                <dl id="select1">
                    ...
                    <dd><a href="javascript:void(0)">男</a></dd>
                    <dd><a href="javascript:void(0)">女</a></dd>
                </dl>
            </li>
            <li class="select-list">
                <dl id="select2">
    ...
    <div class="resources">
        ...
        <!-- 由此开始迭代 -->
				<c:forEach items="${videopallist}" var="vilist" >
					<li class="reso-li" style="margin-top: 0;margin-right: 5px;" onclick="getZhiboDetailById('${vilist.videoPlatform_id}')">
							<div class="resources-t">
								<img src="${vilist.headImgURL }" alt="" />
							</div>
							<div class="newPersonBox">
								<div
									style="font-size: 14px;color: #000;line-height: 30px;text-indent: 8px;">${vilist.name}
								</div>

								<div class="info">简介
									<i>${vilist.introduce}</i>
								</div>
								<div class="fFans">
									<i>粉丝：${vilist.fansNum}</i>
								</div>
							</div>
							<div class="price">
				...
				<c:if test="${videopallist==''||videopallist==null}">
					<p>没有数据。</p>
				</c:if>
        </ul>
