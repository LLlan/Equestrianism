...
<head lang="en">
    ...
    <link rel="stylesheet" href="static/css/xinmeiti/media_xinwen.css"/>
    <script src="static/js/xinmeiti/jquery-2.1.1.min.js"></script>
    <script src="static/js/xinmeiti/page.js"></script>
    <script src="static/js/xinmeiti/media_xinwen.js"></script>
    <title>新闻媒体发布资源管理</title>
</head>
<body>
<!--顶部-->
<div class="main-nav">
...
<div class="Resources">
    <ul>
        ...
        <li><a href="javascript:void(0)" style="color: #ffcc28;" onclick="liuSourcejump(5)">新闻媒体发布</a></li>
...
<div class="container clearfix">
    <div class="container_middle">
        <div class="resource_m">
            ...
            <span>新闻媒体发布资源管理</span>
        </div>
        <div class="resource_t">
            <button class="btn" id="join" onclick="getAdd()">添加</button>
            <button class="btn" id="open">启用</button>
            <button class="btn" id="end">下架</button>
        </div>
        <table class="table">
            <tbody>
            <tr>
	            ...
	            <tr>
	                ...
	                <td>
	                    <a href="javascript:void(0)" onclick="getupdata('${list.media_id}')">
	                        <span class="btn_b" id="updatem">编辑</span>
	                    </a>
	                </td>
	            </tr>
	         </c:forEach>
...
<script>
    ...
    /* 添加 */
   function getAdd(){
   		var url = "api/xmtv2/goAddmedia.do";
   		window.location.href = url;
   }
    
    /* 点击修改按钮能出现的操作 */
    function getupdata(tid){
    	var url = "api/xmtv2/Editmedia.do?tid="+tid;
    	window.location.href = url;
