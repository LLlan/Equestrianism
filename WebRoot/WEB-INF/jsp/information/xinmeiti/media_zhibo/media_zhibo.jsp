...
<base href="<%=basePath%>">
    ...
    <link rel="stylesheet" href="static/css/xinmeiti/media_zhibo.css"/>
    <script src="static/js/xinmeiti/jquery-2.1.1.min.js"></script>
    <script src="static/js/xinmeiti/page.js"></script>
    <script src="static/js/xinmeiti/media_zhibo.js"></script>
    <title>网络视频直播资源管理</title>
</head>
<body>
<!--顶部-->
<div class="main-nav">
...
<div class="container clearfix">
    <div class="container_middle">
        <div class="resource_m">
            <span  class="resource_img"><img style="vertical-align: middle;margin-right: 5px;" src="static/images/xinmeiti/play.png" alt=""/></span>
            <span>网络视频直播资源管理</span>
        </div>
        <div class="resource_t">
         ...
         <script type="text/javascript">
        	//点击添加
        	function addgzhsource(data){
        		/* var url='api/xmtv1/liuAddSourcejump.do?num='+data;
        		window.location.href=url; 
        		var url = 'api/xmtv2/goAdd.do';*/
        		window.location.href ='api/xmtv2/goAdd.do';
        	}
        </script>
        <table class="table">
            <tbody>
            <tr>
            	...
            	<c:forEach items="${volist}" var="list">
		            <tr>
		            	...
		            	<td class="pic"><img src="${list.headImgURL}" alt=""></td>
		            	<td>${list.name }</td>
		            	<td>${list.number }</td>
		            	...
		            	<td>${list.fansNum}</td>
							...
							<td>
		                    <a href="javascript:void(0)" onclick="toEdit('${list.videoPlatform_id}')">
...
<script>
    ...
    /* 修改页跳转 */
    function toEdit(tid){
   		var url = "api/xmtv2/Edit.do?tid="+tid;
   		window.location.href = url;
    }
