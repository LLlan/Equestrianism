...
<base href="<%=basePath%>">
    ...
    <link rel="stylesheet" href="static/css/xinmeiti/pengyouquan_detail.css"/>
    <script src="static/js/xinmeiti/jquery-1.11.1.min.js"></script>
    <script src="static/js/xinmeiti/pengyouquan_detail.js"></script>
    <title>微信朋友圈详情页</title>
</head>
<body>
<!--顶部-->
<div class="top">
    ...
    <div class="col_lf">
        <div class="module_badic_all clearfix">
                ...
                <dd class="list-module" id="varli">
                    ...
                    <div>
                        ...
                        <c:forEach items="${list }" var="list" begin="0" end="0">
                        	<li  class="select" title="${list.price }">${list.name }</li>
                        </c:forEach>
                        <c:forEach items="${list }" var="list" begin="1">
                        	<li  class="" title="${list.price }">${list.name }</li>
                        </c:forEach>
                        </ul>
                        <script type="text/javascript">
                        	$(function() {
            ...
            <script type="text/javascript">
            	...
            	function creatOrder(tag_id){
            		var url="api/xmtv1/toPyqCreateOredr.do?tag_id="+tag_id;
                	window.open(url);
            	}
            </script>
        </div>
        ...
        <div class="per_module clearfix">
            ...
            <c:forEach items="${list1 }" var="list" begin="0" end="3">
            	<li onclick="jumpTodetail('${list.WCfriends_id}');">
