...
<base href="<%=basePath%>">
    ...
    <link rel="stylesheet" href="static/css/xinmeiti/pengyouquan_resource_list.css"/>
    <script src="static/js/xinmeiti/jquery-2.1.1.min.js"></script>
    <script src="static/js/xinmeiti/page.js"></script>
    <script src="static/js/xinmeiti/pengyouquan_resource_list.js"></script>
    <script type="text/javascript" src="static/js/jquery.tips.js"></script><!--提示框-->
    <title>微信朋友圈资源管理</title>
</head>
<body>
<!--顶部-->
<div class="main-nav">
...
<div class="Resources">
    <ul>
        ...
        <li><a href="javascript:void(0)" style="color: #ffcc28;" onclick="liuSourcejump(2)">微信朋友圈</a></li>
    ...
    <div class="container_middle">
        ...
        <script type="text/javascript">
        	...
        	function addgzhsource(){
        		var url='api/xmtv1/liuAddSourcejump.do?num=2';
        		window.location.href=url;
        	}
        </script>
        <table class="table">
            ...
            <tr>
             ...
             <c:forEach items="${list1p }" var="list" varStatus="vs" end="9">
             	<tr>
             	<td class='center' style="width: 30px;">
            		<c:if test="${list.checkedState=='1' }">
            			<label><input type='checkbox' name='ids' value="${list.WCfriends_id }"/><span class="lbl"></span></label>
            		</c:if>
				</td>
                ...
                <td>
                    <a href="javascript:void(0)">
                        <span class="btn_b" onclick="pyqtoUpdate('${list.WCfriends_id }')">编辑</span>
                    </a>
                </td>
            </tr>
             </c:forEach>
...
<script>
  ...
  //点击编辑
    function pyqtoUpdate(tag_id) {
		var url='api/xmtv1/toPyqEdite.do?tag_id='+tag_id;
		window.location.href=url;
	}
  //批量启用和下架
	function changeStateAll(msg) {
		...
		//bootbox.confirm(msg,function(result){
			//if(result){
				...
				$.ajax({
					type:'post',
					url:'<%=basePath%>api/xmtv1/changePyqsourceState.do',
					dataTyoe:'json',
					cache: false,
					data:{
						"ids":str,
