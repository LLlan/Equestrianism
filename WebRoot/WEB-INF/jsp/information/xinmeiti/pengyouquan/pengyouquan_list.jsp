...
<base href="<%=basePath%>">
    ...
    <link rel="stylesheet" href="static/css/xinmeiti/pengyouquan.css"/>
    ...
    <script src="static/js/xinmeiti/pengyouquan.js"></script>
    <title>微信朋友圈</title>
</head>
<body>
<!--顶部-->
...
<div class="listFrm clearfix">
    ...
    <div class="resources">
        ...
        <c:forEach items="${list }" var="list" begin="0" end="9">
			<li class="reso-li" style="margin-top: 0;margin-right: 5px;" onclick="jumpTodetail('${list.WCfriends_id}');">
