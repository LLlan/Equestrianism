...
<base href="<%=basePath%>">
    ...
    <link rel="stylesheet" href="static/css/xinmeiti/xinwen_detail.css"/>
    <script src="static/js/xinmeiti/jquery-1.11.1.min.js"></script>
    <script src="static/js/xinmeiti/xinwen_detail.js"></script>
    <title>新闻发布详情页</title>
</head>
<body>
<!--顶部-->
...
<div class="The_stage clearfix">
    <div class="n_position">
        ...
        >
        <span><a href="#">新闻发布</a></span>
        >
        <span>${pd.media_name}</span>
    </div>
    <div class="col_lf">
        ...
        <div class="per_module clearfix">
            <div class="ml-title">
	            ...
	            <c:forEach items="${mslist}" var="list" begin="0" end="3">
	                <li onclick="getXinwenDetailById('${melist.media_id}')">
        ...
        <div class="more-right">
            <div class="mr-title">人气榜</div>
            	...
            	<c:forEach items="${mslist}" var="list" end="6">
		            <dl class="more-people" onclick="getXinwenDetailById('${list.media_id}')>
		                <a href="javescript:void(0)" target="_blank" >
		                    <dt>
