...
<div class="Resources">
    <ul>
        ...
        <li><a href="javascript:void(0)" onclick="liuSourcejump(5)" style="color: #ffcc28;">新闻媒体发布</a></li>
...
<!--主体-->
<!--派单列表-->
<form action="api/guangGaoOrderList/xinWenselectlistpage.do" method="post" id="x">
<div class="body">
    <div class="container">
        ...
        <div class="my_Timer clear" style="padding: 20px 0 40px 0   ">
            <div class="w_water">
                订单名称
                <input type="text" class="run_name run_water " name="newsOrder_title" value="">
            </div>
            <div class="w_water" style="margin-left: 40px;">
                订单编号
                <input type="text" class="run_name  run_water" name="newsOrder_id" value="">
            </div>
            <div>
        ...
        <table style="display: block"  class="table">
            ...
            <tr>
            	<th>${pd.newsOrder_id }</th>
            	<th>${pd.newsOrder_title }</th>
            	<th>${pd.media_name }</th>
            	<th>${pd.price }</th>
