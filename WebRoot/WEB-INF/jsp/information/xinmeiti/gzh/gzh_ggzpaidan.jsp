...
<div class="Resources">
    <ul>
        <li><a href="javascript:void(0)" onclick="liuSourcejump(1)" style="color: #ffcc28;">微信公众号</a></li>
...
<div class="body">
    <div class="container">
        ...
        <form action="<%=basePath %>api/xmtv1/toGgzorderGzhlist.do" id="shaixuanForm" method="post"> 
