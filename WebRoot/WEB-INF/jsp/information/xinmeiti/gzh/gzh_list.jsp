...
<base href="<%=basePath%>">
	...
	<link rel="stylesheet" href="static/css/xinmeiti/gzh.css"/>
	...
	<script src="static/js/xinmeiti/gzh.js"></script>
	<title>微信公众号</title>
</head>
<body>
<!--顶部-->
...
<div class="listFrm clearfix">
	...
	<div class="resources">
		...
		<c:forEach items="${list }" var="list" begin="0" end="9">
			<li class="reso-li" style="margin-top: 0;margin-right: 5px;" onclick="jumpTodetail('${list.WCpublic_id}');">
