...
<div class="Resources">
    <ul>
        ...
        <li><a href="javascript:void(0)" onclick="liuSourcejump(3)" style="color: #ffcc28;">微博</a></li>
...
<div class="body">
    <div class="container">
        ...
        <form action="<%=basePath %>api/xmtv1/toGgzorderWblist.do" id="shaixuanForm" method="post"> 
        ...
        <table style="display: block"  class="table">
            ...
            <tr>
                ...
                <th>
                	<a href="${list.microBlogHttp }" target="_blank">点击进入微博</a>
                </th>
                <%--
                <th>资源头像</th>
                --%>
