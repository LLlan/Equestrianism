...
<div class="Resources">
    <ul>
        ...
        <li><a href="<%=basePath %>api/xmtv1/toMjzorderPyqlist.do">微信朋友圈</a></li>
        <li><a href="<%=basePath %>api/xmtv1/toMjzorderWblist.do" style="color: #ffcc28;">微博</a></li>
    ...
    <div class="container">
        ...
        <table style="display: block"  class="table">
            ...
            <tr>
                ...
                <th><a href="${list.microBlogHttp }" target="_blank">点击进入微博</a></th>
                <%--
                <th>资源头像</th>
