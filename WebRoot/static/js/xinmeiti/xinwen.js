...
function shaixuan() {
	...
	$.ajax({
		type:"post",
		url:"api/xmtv2/mediaShaixuan.do",
		data:{
			"selectA":selectA,
			"selectB":selectB,
			"selectC":selectC
		...
		success:function(data){
			...
			$.each(data.list,function(i,j){
				if(i<=9){
					str+="<li class='reso-li' style='margin-top: 0;margin-right: 5px;' onclick='jumpTodetail(\""+j.media_id+"\");'>";
					str+='<a href="javascript:void(0)">';
					str+='<div class="resources-t">';
					str+='<img src="'+projectName+'/'+j.media_logo+'" alt=""/>';
					str+='</div>';
					str+='<div class="newPersonBox">';
					str+='<a href="javascript:void(0)">';
					str+='<div style="font-size: 14px;color: #000;line-height: 30px;text-indent: 8px;">'+j.media_name+'</div>';
					str+='</a>';
					str+='<a href="javascript:void(0)">';
					str+='<div class="info">'+j.media_intro+'</div>';
					str+='</a>';
					str+='<div class="fFans">';
